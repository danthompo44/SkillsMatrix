...
insert into app_user(username, password, email) values ('user1', '$2a$10$0tkDsotEK5feenJ.9wl5OO8TV5OB.gO7hzBMX1z.LFsIF/8OmpAiC', 'user2@email.com');
insert into app_user(username, password, email) values ('user2', '$2a$10$0tkDsotEK5feenJ.9wl5OO8TV5OB.gO7hzBMX1z.LFsIF/8OmpAiC', 'user3@email.com');
...
insert into staff(details_id, user_id, manager_id) values (4, 3, 1);
...
insert into staff_skill(created_at, expiry_date, skill_strength, staff_id, skill_id) values ('2021-8-21', '2023-08-21', 5, 2, 2);
